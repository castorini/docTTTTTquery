...
The following command will train a T5-base model for 4k iterations to predict queries from documents. We assume you put the tsv training file in `gs://your_bucket/doctttttquery/data/doc_query_pairs.train.tsv`. Also, please change `your_tpu_name`, `your_project_id`, and `your_bucket` accordingly.
...
t5_mesh_transformer  \
  ...
  --model_dir="gs://your_bucket/doctttttquery/models/" \
  ...
  --gin_param="tsv_dataset_fn.filename = 'gs://your_bucket/doctttttquery/data/doc_query_pairs.train.tsv'" \
